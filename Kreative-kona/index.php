...
include('include/newArrival.php');

include('include/featuredpro.php');
?>
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">Product name</a></h4>
									<div class="info-product-price">
										<span class="item_price">RS. 99.99</span>
										<del>RS. 109.71</del>
									</div>
									<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">Product name</a></h4>
									<div class="info-product-price">
										<span class="item_price">RS. 79.99</span>
										<del>RS. 120.71</del>
									</div>
									<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">Product name</a></h4>
									<div class="info-product-price">
										<span class="item_price">RS. 129.99</span>
										<del>RS. 150.71</del>
									</div>
									<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">T Product name</a></h4>
									<div class="info-product-price">
										<span class="item_price">RS. 45.99</span>
										<del>RS. 69.71</del>
									</div>
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4><a href="single.html">Product name Domyos</a></h4>
									<div class="info-product-price">
										<span class="item_price">RS. 45.99</span>
										<del>RS. 69.71</del>
									</div>
